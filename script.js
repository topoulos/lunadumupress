...
(() => {
  ...
  function buildHeroImages(level) {
    ...
    list.push(`images/public/west_comm_tower.jpg?v=${VERSION}`); // west comm tower wide shot
    ...
    list.push(`images/public/105_sam_kelli_karaoke_bar.jpg?v=${VERSION}`); // family night
